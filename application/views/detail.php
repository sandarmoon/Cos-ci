<div class="col-lg-10 mb-5">
                ...
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    <div class="card-header justify-content-center">
                        <h3 class="font-weight-light my-4 text-center"> Detail Information  </h3>
                    </div>

                    <form action="<?= site_url('suggest/store') ?>" method="POST">
                            ...
                            <div class="row my-3">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="careerlife" type="text" placeholder="Enter Your Suggestion" name="careerlife" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="fileerror" type="text" placeholder="Enter Your Suggestion" name="fileerror" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="teamwork" type="text" placeholder="Enter Your Suggestion" name="teamwork" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="stress"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="rolemodel" type="text" placeholder="Enter Your Suggestion" name="rolemodel" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="phapplication" type="text" placeholder="Enter Your Suggestion" name="phapplication" />
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="website" type="text" placeholder="Enter Your Suggestion" name="website" />
                                    </div>
                                </div>
